        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem title="Your Profile" link={Routes.DashboardOverview.path4} icon={faChartPie} />
              <NavItem title="Patient Tests" icon={faChartPie} link={Routes.PatientTest.path} />
              <NavItem title="Patient Treatments" icon={faChartPie} link={Routes.PatientTreatment.path} />
              <NavItem title="Patient Doses" icon={faChartPie} link={Routes.PatientDose.path} />
              <Dropdown.Divider className="my-3 border-indigo" />
              <NavItem title="Add Procedures" icon={faChartPie} link={Routes.AddProcedure.path} />
              <NavItem title="Add Medications" icon={faChartPie} link={Routes.AddMedication.path} />
              <NavItem title="Add Rooms & Blocks" icon={faChartPie} link={Routes.AddRoom.path} />
              <NavItem title="Show Medications" icon={faChartPie} link={Routes.MedicineShow.path2} />
